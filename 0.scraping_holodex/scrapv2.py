...
MAX_TOTAL = 278550  # Maksimal total data yang ingin diambil (bisa diatur)
START_OFFSET = 270000  # Offset awal untuk melanjutkan pengambilan data
...
if __name__ == "__main__":
    offset = START_OFFSET  # Mulai dari offset yang ditentukan
